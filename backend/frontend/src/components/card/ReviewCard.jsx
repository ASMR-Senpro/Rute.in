...
const reviewcard = () => {
    return (
        <div className="flex flex-col p-4 border-[3px] rounded-[25px] border-beige-100">
            <div class="flex items-center font-Poppins font-medium text-h-sm space-x-4">Nama Pengguna</div>
            <div class="flex items-center mb-1">
                ...
                <svg aria-hidden="true" class="w-5 h-5 text-base" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Fifth star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <h3 class="ml-2 text-sm font-semibold text-base">4.8</h3>
            </div>
            <div class="font-Poppins text-[18px]">It is obviously not the same build quality as those very expensive watches. But that is like comparing a Citroën to a Ferrari. This watch was well under £100! An absolute bargain.</div>
        </div>
    )
}
