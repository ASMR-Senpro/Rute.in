    ...
    <div class="justify-center flex flex-row space-x-2 bg-transparent h-48">
        ...
        <div class="justify-center flex flex-col items-center bg-cyan-700 border-0 rounded-lg shadow md:flex-row md:max-w-3xl">
            <div class="flex flex-col justify-between p-4 leading-normal">
                <h5 class="mb-2 text-h-lg font-bold tracking-tight text-gray-900 dark:text-white">Nama Lokasi</h5>
                <p class="mb-3 text-b-xl font-normal text-white dark:text-gray-400">ini alamat lokasi Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
                <a href="#" class="text-right text-b-sm mb-3 font-normal text-white dark:text-gray-400">...klik untuk detail</a>
            </div>
        </div>
    </div>
  )
