...
const Article = () => {
    return (
        <div>
            ...
            <div className="flex flex-col gap-4 justify-center items-center my-[20px]">
                {/* Judul dan rating tempat */}
                <div className="flex flex-row justify-center items-center">
                    <div id="name" className="flex font-Poppins font-medium w-[930px] text-[64px]">Malioboro</div>
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex border-b-[3px] border-orange-700 font-Poppins font-medium text-h-md w-[1200px]">Deskripsi</div>
                    <div className="flex font-Poppins text-[18px] w-[1200px]">
                ...
                {/* Fasilitas */}
                <div className="flex flex-col gap-4">
                    <div className="flex border-b-[3px] border-orange-700 font-Poppins font-medium text-h-md w-[1200px]">Fasilitas</div>
                ...
                {/* Lokasi */}
                <div className="flex flex-col gap-4">
                    <div className="flex border-b-[3px] border-orange-700 font-Poppins font-medium text-h-md w-[1200px]">Lokasi</div>
                    <div className="flex flex-row gap-4 w-[1200px]">
                        <img src={MapImg}></img>
                        <div className="flex font-Poppins text-[18px] w-[1200px]">
